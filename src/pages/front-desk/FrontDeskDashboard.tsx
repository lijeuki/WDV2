...
import { CheckoutQueue } from '../../components/organisms/CheckoutQueue';
  ...
  return (
    <DashboardLayout role="front-desk">
      <div className="p-8">
        ...
        {/* Checkout Queue - Connected from Doctor */}
        <div className="mt-6">
          <CheckoutQueue frontDeskId="FD001" frontDeskName="Front Desk Staff" />
        </div>
        ...
        <div className="mt-6 p-4 bg-teal-50 border border-teal-200 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-medium text-teal-900 mb-1">🔗 Connected to Doctor</h4>
              <p className="text-sm text-teal-700">
                Completed exams from doctors will automatically appear in the Checkout Queue above for payment processing.
              </p>
            </div>
          </div>
        </div>
